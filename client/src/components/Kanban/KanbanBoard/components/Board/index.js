...
import {withDroppable, withDroppableColumns} from '../withDroppable'
...
const Columns = forwardRef((props, ref) => <div ref={ref}  {...props} />)

const DroppableColumns = withDroppableColumns(Columns)
  ...
  return (
    <DragDropContext onDragEnd={handleOnDragEnd}>
      <div className='react-kanban-board '>
        <DroppableColumns droppableId='board-droppable' direction='horizontal' type='BOARD'>
